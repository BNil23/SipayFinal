<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="odemesayfasi3dmodel2.aspx.cs" Inherits="test3.odemesayfasi3dmodel2" %>
...
<h1>3D Ödeme Sayfası</h1>
    ...
    <%
        ...
        String nameval = "gursoyadmin";         //İşyeri kullanıcı adı
        String passwordval = "KLYT6522";       //İşyeri şifresi
        ...
        if (mdstatus.Equals("1") || mdstatus.Equals("2") || mdstatus.Equals("3") || mdstatus.Equals("4")) //3D Onayı alınmıştır.
        {
            ...
            String url = "https://www.sanalakpos.com/fim/api";
