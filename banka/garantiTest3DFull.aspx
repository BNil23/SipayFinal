<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="garantiTest3DFull.aspx.cs" Inherits="test3.garantiTest3DFull" %>
...
<body id="kt_body" class="app-blank">
    <form id="form2" runat="server" method="post" action="https://sanalposprov.garanti.com.tr/servlet/gt3dengine">
        <div>
                                    ...
                                    <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                        ...
                                        <div class="mt-n1">
                                            ...
                                            <div class="d-flex flex-stack pb-10">
                                                <!--begin::Logo-->
                                                <a href="https://www.murataktas.co.uk/">
                                                    <img alt="Logo" src="https://healthcenter.asistcrm.com/works/Clinic/murat_aktas_antet_ust2.JPG" style="width: 100%" />
                                                </a>
                                                <!--end::Logo-->
                                            </div>
                                            <!--end::Top-->
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="row g-5 mb-12">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--end::Text-->
                                                        <div class="fw-bold fs-6 text-gray-800">Murat Aktaş Health Center</div>
                                                        <!--end::Text-->
                                                        <!--end::Description-->
                                                        <div class="fw-semibold fs-7 text-gray-600">

                                                            <br>
                                                            EGE MAH. 451 SK. NO: 1 /11 KAPI NO: 7
                                                                      KUŞADASI / AYDIN
                                                        </div>
                                                        <!--end::Description-->
                                                    </div>
                                                ...
                                                <div id="kt_modal_new_card_form" class="form">
                                                    ...
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        ...
                                                        <div class="position-relative">
                                                            <!--begin::Input-->
                                                            <%--<input type="text" class="form-control form-control-solid" id="cardnumber" placeholder="XXXX XXXX XXXX XXXX" name="cardnumber" value="" />--%>
                                                                <asp:TextBox class="form-control form-control-solid" id="cardnumber" runat="server" ></asp:TextBox>
                                                    ...
                                                    <div class="row mb-10">
                                                        ...
                                                        <div class="col-md-8 fv-row">
                                                            ...
                                                            <div class="position-relative">
                                                                ...
                                                                <asp:TextBox class="form-control form-control-solid" id="cardexpiredatemonth" runat="server"></asp:TextBox>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input wrapper-->
                                                        </div>
                                                            ...
                                                            <div class="position-relative">
                                                                <!--begin::Input-->
                                                                <%--<input type="text" class="form-control form-control-solid" id="cardcvv2" minlength="3" maxlength="4" value="" placeholder="CVV" name="card_cvv" />--%>
                                                                <asp:TextBox class="form-control form-control-solid" id="cardexpiredateyear" runat="server"></asp:TextBox>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input wrapper-->
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 fv-row">
                                                            ...
                                                            <div class="position-relative">
                                                                <!--begin::Input-->
                                                                <%--<input type="text" class="form-control form-control-solid" id="cardcvv2" minlength="3" maxlength="4" value="" placeholder="CVV" name="card_cvv" />--%>
                                                                <asp:TextBox class="form-control form-control-solid" id="cardcvv2" runat="server"></asp:TextBox>
                                                                <!--end::Input-->
                                                                <!--begin::CVV icon-->
                                                    ...
                                                    <div class="text-center pt-5">
                                                        ...
                                                        <br />
                                                        <br />
                                                        EGE MAH. 451 SK. NO: 1 /11 KAPI NO: 7 KUŞADASI / AYDIN
                                                         <br />
                                                        <h5>EN: +44 7840 286858</h5>
                                                        <h5>DE: +49 1525 657 4690</h5>
                                                        <br />
...
<%--<form id="form2" runat="server">
    <div>
        ...
        <br />
        Expire Date (mm):
            <asp:TextBox ID="cardexpiredatemonth" runat="server" />
        <br />
        Expire Date (yy):
            <asp:TextBox ID="cardexpiredateyear" runat="server" />
        <br />
        CVV2:
            <asp:TextBox ID="cardcvv2" runat="server" />
        <br />--%>
