 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="odemesayfasi3dmodel.aspx.cs" Inherits="test3.odemesayfasi3dmodel" %>
...
<h1>3D Ödeme Sayfası</h1>
    ...
    <%
        ...
        String nameval = "102559963api";              //İşyeri kullanıcı adı
        String passwordval = "TEST1010";        //İşyeri şifresi
        ...
        if (mdstatus.Equals("1") || mdstatus.Equals("2") || mdstatus.Equals("3") || mdstatus.Equals("4")) //3D Onayı alınmıştır.
        {
            ...
            String url = "https://testvpos.asseco-see.com.tr/fim/api";
