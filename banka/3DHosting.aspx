<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="3DHosting.aspx.cs" Inherits="test3._3DHosting" %>
...
<%
    ...
    //  İŞ YERLERİNE REFERANS AMAÇLI OLUŞTURULMUŞTUR.
        ...
        String clientId = "******"; //Banka tarafından verilen işyeri numarası
        String amount = "0.01";        //işlem tutarı
        String oid = "*****";               //Sipariş numarası
        String okUrl = "https://localhost:44390/odemesayfasi3dmodel2.aspx"; //işlem başarılıysa dönülecek web sayfası
        String failUrl = "https://localhost:44390/odemesayfasi3dmodel2.aspx"; //işlem başarısızsa dönülecek web sayfası
