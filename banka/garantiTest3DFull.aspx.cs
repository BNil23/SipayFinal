...
namespace test3
{
    public partial class garantiTest3DFull : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string strcustomeremailaddress = "info@tradesis.com";
                ...
                //string strSuccessURL = "https://localhost:44390/garantiTest3DPayResult.aspx";
